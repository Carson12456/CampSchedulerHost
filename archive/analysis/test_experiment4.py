"""
Test Experiment 4: Multi-pass cross-schedule clustering
"""
...
print("="*70)
print("EXPERIMENT 4: Multi-pass Cross-schedule Clustering")
print("="*70)
...
print(f"\n  Reflections: {metrics['reflection_count']}/{metrics['total_troops']}")
...
print("\n" + "="*70)
print("COMPARISON: Baseline vs Multi-pass")
print("="*70)
print("                    | Baseline | Multi-pass")
print("-"*55)
