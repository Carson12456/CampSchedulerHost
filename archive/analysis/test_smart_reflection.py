"""
Test Smart Reflection Scheduling: Fill Friday slots progressively,
schedule Reflection when only 1 slot remains.
"""
...
def analyze_schedule(schedule, scheduler):
    ...
    for e in schedule.entries:
        if e.activity.name == "Reflection":
            reflection_slots[e.time_slot.slot_number] += 1
...
print("="*70)
print("SMART REFLECTION SCHEDULING")
print("="*70)
...
print(f"\nWeek 7 Results:")
print(f"\n  CRITICAL: Reflections Scheduled: {metrics['reflection_count']}/{metrics['total_troops']}")
...
print("\n" + "="*70)
print("COMPARISON: Baseline vs Smart Reflection")
print("="*70)
print("                    | Baseline | Smart")
print("-"*50)
